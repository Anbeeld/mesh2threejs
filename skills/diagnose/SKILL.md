...
- **derived mode**: prefer a less aggressive derived seed (`derive --quality balanced|conservative`), protect the failing region/features, apply a local procedural repair, or switch representation only for the failing subcomponent.
